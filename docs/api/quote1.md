...
> 注意，在引入 consts 之后， （`from mootdx2 import consts`）
...
注意，在引入 consts 之后， （`from mootdx2 import consts`） 我们可以使用 consts.MARKET_SH , consts.MARKET_SZ 常量来代替 1 和 0 作为参数
